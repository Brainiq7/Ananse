...
class BambuserIE(InfoExtractor):
    ...
    _TEST = {
        ...
        # MD5 seems to be flaky, see https://travis-ci.org/rg3/ananse/jobs/14051016#L388
        ...
        'params': {
            ...
            # caused the travis builds to fail: https://travis-ci.org/rg3/ananse/jobs/14493845#L59
            'skip_download': True,
        },
    }
