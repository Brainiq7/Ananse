    ...
    _TESTS = [{
                  ...
                  'playlist': [{
                                   'info_dict': {
                                       ...
                                       'description': '\xa9 2014 Munchkin the Shih Tzu\nAll rights reserved\n\nFacebook: http://facebook.com/MunchkintheShihTzu\nInstagram: http://instagram.com/munchkintheshihtzu\n\nlicensing@rumble.com',
                                       'uploader': 'Munchkin the Shih Tzu',
                                       'title': 'Munchkin the Teddy Bear gets her exercise ORIGINAL',
                                   },
                               }]
              }]
